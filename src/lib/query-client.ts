...
export const helmorQueryKeys = {
  ...
  workspaceDetail: (workspaceId: string) => ["workspaceDetail", workspaceId] as const,
  workspaceSessions: (workspaceId: string) => ["workspaceSessions", workspaceId] as const,
...
export function sessionMessagesQueryOptions(workspaceId: string, sessionId: string) {
  return queryOptions({
...
export function sessionAttachmentsQueryOptions(workspaceId: string, sessionId: string) {
  return queryOptions({
